...
def request_sanitize_operation(prompt: str, expected_operations: list) -> str:
    """
    Function to request and sanitize user input for the operation

    Returns: 
        string: The sanitized word input by the user.
    """
...
def main():
    ...
    operation = request_sanitize_operation("Enter the operation (add, subtract, multiply, divide): ", expected_operations).strip().lower()
